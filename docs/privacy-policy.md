...
**This app collects and transmits no information whatsoever.** The PDFs you open, and their contents, never leave your PC.

### Information we collect

**None.** The app collects no personal data, no usage data, no device information, and no identifiers. There is no account to create.

### Network activity

The app performs **no network communication** to analyze, edit, or save PDFs.

The single exception is when you choose **Help → Online Manual**: your default browser opens the manual page hosted on GitHub. That is your browser making the request, not the app. If you never use that menu item, the app never contacts anything external.
...
The app stores exactly two things locally. **Neither is ever transmitted.**
...
Since no information is collected, none is shared. The app embeds no advertising, analytics, or crash-reporting services.

### Children's privacy

The app collects no information from users of any age.

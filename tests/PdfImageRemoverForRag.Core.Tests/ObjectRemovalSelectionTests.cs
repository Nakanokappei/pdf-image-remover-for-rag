...
public class ObjectRemovalSelectionTests
{
    ...
    public void RecordEquality_IgnoresListIdentity_ButRespectsContents()
    {
        ...
        var occ1 = new ObjectOccurrence(1, "1 0 R", "/Im1", 0, 0, 100, 60);
        var occ2 = new ObjectOccurrence(1, "1 0 R", "/Im1", 0, 0, 100, 60);

        var a = new ObjectRemovalSelection("IMG_001", new[] { occ1 });
        var b = new ObjectRemovalSelection("IMG_001", new[] { occ1 });
        var c = new ObjectRemovalSelection("IMG_002", new[] { occ1 });
    ...
    public void Record_IsImmutable()
    {
        ...
        var selection = new ObjectRemovalSelection("IMG_001", Array.Empty<ObjectOccurrence>());
    ...
    public void Selection_MayCarryMultipleOccurrences()
    {
        ...
        var occurrences = new[]
        {
            ...
            new ObjectOccurrence(2, "1 0 R", "/Im1", 0, 0, 100, 100),
        };
